...
#     time.sleep(3)
#     driver.execute_script(
#         "document.querySelector('#root > div > main > div > div > div:nth-child(1) > div.col > div > div > div:nth-child(3) > button').scrollIntoView();")
#     time.sleep(3)
#     driver.find_element(By.CSS_SELECTOR,
#                               "#root > div > main > div > div > div:nth-child(1) > div.col > div > div > div:nth-child(3) > button").click()
#     time.sleep(1)
